---
layout: default
title: Mac Zsh Completions - Enterprise Solution
...
<div class="tiation-hero">
  ...
  <div class="hero-content">
    ...
    <h1 class="hero-title">
      ...
      <span class="gradient-text">Mac Zsh Completions</span>
    </h1>
    ...
    <div class="hero-cta">
      ...
      <a href="https://github.com/tiation/mac-zsh-completions" class="btn-tertiary">📁 View Code</a>
    </div>
  </div>
</div>
...
```bash
# Build Docker image
docker build -t mac-zsh-completions .

# Run container
docker run -p 8080:8080 mac-zsh-completions
```
...
### 📞 Getting Help
- **📚 Documentation**: [Full documentation](https://tiation.github.io/mac-zsh-completions)
- **❓ FAQ**: [Frequently asked questions](faq.md)
- **🐛 Issues**: [GitHub Issues](https://github.com/tiation/mac-zsh-completions/issues)
- **💬 Discussions**: [GitHub Discussions](https://github.com/tiation/mac-zsh-completions/discussions)
